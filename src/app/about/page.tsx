...
const teamMembers = [
  ...
  },
  {
    ...
    image: 'https://i.ibb.co/cK1V41k/Compress-JPEG-Online-img-250x400.jpg',
    dataAiHint: 'institute owner',
  },
  {
    name: 'Jeevan Singh',
  ...
  },
  {
    ...
    image: 'https://i.ibb.co/Pv1xJFL/Whats-App-Image-2025-06-29-at-1-03-58-PM.jpg',
    dataAiHint: 'man developer',
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-12">
            ...
            <div className="order-1 md:order-2 group">
              <Image
                src="https://i.ibb.co/jv8gNqN/Compress-JPEG-Online-img-800x600.jpg"
            ...
            {timeline.map((item, index) => (
              <div key={index} className="relative mb-8 flex w-full items-center md:justify-between md:odd:flex-row-reverse group">
                ...
                <div className="w-full pl-12 md:w-5/12 md:pl-0">
                  <Card className="p-4 md:p-6 transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 md:gap-8">
            {teamMembers.map((member, index) => (
              <div key={`${member.name}-${index}`} className="group">
                <Card className="text-center transition-transform duration-300 group-hover:scale-105 group-hover:shadow-xl">
