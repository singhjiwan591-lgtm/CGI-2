      ...
      <section className="w-full bg-secondary py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base md:text-lg text-foreground/80">
            Join Web an d App. Learn about our simple enrollment process.
          </p>
        </div>
      </section>
      ...
      <section className="w-full py-12 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center mx-auto mt-4 max-w-2xl text-foreground/80">
            We have a straightforward admissions process. Follow these steps to begin your journey at Web an d App.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto mt-10 max-w-2xl">
            <ul className="space-y-4">
              {keyDates.map((item) => (
                <li key={item.event} className="flex items-center rounded-lg bg-background p-4 shadow transform transition-transform duration-300 hover:scale-105">
